...
FRAMEWORK_LINEAGE_API_NEEDS_UPDATE_TEXT := $(TOPDIR)vendor/somefeakos/build/core/apicheck_msg_current.txt

BUILD_RRO_SYSTEM_PACKAGE := $(TOPDIR)vendor/somefeakos/build/core/system_rro.mk
...
include $(TOPDIR)vendor/somefeakos/build/core/mtk_target.mk

# Rules for QCOM targets
include $(TOPDIR)vendor/somefeakos/build/core/qcom_target.mk
